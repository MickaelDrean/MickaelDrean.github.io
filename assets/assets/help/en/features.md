...
To edit a session on the curve, click the button ![screenshot1](assets/help/en/images/SessionExplorationEditCurveSessionButton.png) located on the row of the session you wish to edit.
See the chapter ***Editing a Session on the Curve*** for more details.
...
In editing mode you can:
 - **Create a new proposition** after an existing one by clicking the button ![screenshot1](assets/help/en/images/SessionEditionAddPropositionButton.png) located on the existing proposition's line,
 - **Create a new proposition** in the last position of the session by clicking the button ![screenshot1](assets/help/en/images/SessionEditionAddPropositionButton.png) located in the banner at the bottom of the screen,
...
In the session editor on the curve you can:
 ...
 - **Listen to a proposition's music** by clicking on the button ![screenshot1](assets/help/en/images/PlayButton.png) for that proposition,
 ...
 - **Delete a proposition** by clicking on the button ![screenshot1](assets/help/en/images/SessionEditionOnCurveDeleteButton.png) for that proposition
